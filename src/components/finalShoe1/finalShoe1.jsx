...
// 批量引入shoe圖片
import { shoeImages } from '../../Store/modules/shoe.js'
...
export default function Finalshoe() {
    ...
    const index=shoeImages.findIndex(item=>item.includes(pathClip))
  ...
  return (
    <div className='finalShoeContainer'>
      <div className='finalBag'>
          ...
          <img className='shoe' src={shoeImages[index]} alt='' />
